...
@section('content')
<?php $page = str_replace("teacher.", " ", Route::currentRouteName()); ?>
<div class="col-md-12">
	<div class="card">
				...
				@csrf
					<div class="row">
						...
						<div class="form-group col-md">
							...
							<input type="text" class="form-control" id="phone_no" name="phone_no" autocomplete="off" value="">
						</div>
						<div class="form-group col-md">
							<label for="subject">Subject<span class="text-danger">*</span></label>
							<input type="text" class="form-control" id="subject" name="subject" autocomplete="off" value="">
						</div>
